...
public class GraphActivity extends BaseActivity {
    ...
    private SimpleDateFormat dateFormat = new SimpleDateFormat("E") {{ setTimeZone(TimeZone.getDefault()); }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        darkTheme = theme == R.style.AppTheme_NoActionBar_Dark || theme == R.style.AppTheme_NoActionBar_Black ||
                    theme == R.style.AppTheme_NoActionBar_Classic_Dark || theme == R.style.AppTheme_NoActionBar_Classic_Black;
...
//البارات بتاعت الرسمات وتغيير الوحدات
    ...
    /**
     * Returns a comparable abstract length/width an integer number uses as a chart label
     * (works best for fonts with monospaced digits).
     * @param i number
     * @return length
     */
