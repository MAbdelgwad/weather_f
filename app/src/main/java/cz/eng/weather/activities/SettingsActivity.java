...
public class SettingsActivity extends PreferenceActivity
    ...
    // sunday 1999-3-28 9:50:00
    private Date SAMPLE_DATE = new Date(922607408000L);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        boolean blackTheme= theme == R.style.AppTheme_NoActionBar_Black ||theme == R.style.AppTheme_NoActionBar_Classic_Black;
...
//        setCustomDateEnabled();
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        switch (key) {
            ...
            case "speedUnit":
            case "pressureUnit":
            case "windDirectionFormat": setListPreferenceSummary(key);break;
