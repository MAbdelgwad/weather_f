package cz.eng.weather.notifications.ui;

import androidx.annotation.NonNull;

import cz.eng.weather.utils.formatters.WeatherFormatter;
import cz.eng.weather.utils.formatters.WeatherFormatterFactory;
import cz.eng.weather.utils.formatters.WeatherFormatterType;
...
public abstract class NotificationContentUpdaterFactory {
     ...
     */
    @NonNull
    public static NotificationContentUpdater createNotificationContentUpdater(@NonNull WeatherFormatterType type) {
     ...
     */
    public static boolean doesContentUpdaterMatchType(@NonNull WeatherFormatterType type,
                                                      @NonNull  NotificationContentUpdater contentUpdater) {
        return (type == WeatherFormatterType.NOTIFICATION_DEFAULT && contentUpdater instanceof DefaultNotificationContentUpdater)
                ||
                (type == WeatherFormatterType.NOTIFICATION_SIMPLE && contentUpdater instanceof SimpleNotificationContentUpdater);
    }
}
