package cz.eng.weather.weatherapi;
...
//الكلاس دة اللي بيخزن من خلاله ال cityId وlastToday و lastLongterm و lastUVIToday و latitude
// في sharedPreferences
public class WeatherStorage {
    protected SharedPreferences sharedPreferences;

    public WeatherStorage(Context context) { this.sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context); }
    ...
    // لو فية بيانات جديدة في ال sharedPreferences لل cityId هاتها والا خد الديفولت
