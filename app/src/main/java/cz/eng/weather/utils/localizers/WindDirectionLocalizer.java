package cz.eng.weather.utils.localizers;
...
public abstract class WindDirectionLocalizer {
    ...
    @NonNull
    public static String localizeWindDirection(@NonNull Weather.WindDirection direction, @NonNull String format, @NonNull Context context)
