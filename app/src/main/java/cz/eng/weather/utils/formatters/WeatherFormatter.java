...
public abstract class WeatherFormatter {
    ...
    @NonNull
    public static String getWeatherIconAsText(int weatherId, boolean isDay, @NonNull Context context) {
    ...
    public static Bitmap getTemperatureAsBitmap(
        ...
        final Bitmap bitmap = Bitmap.createBitmap((int) size, (int) size, Bitmap.Config.ARGB_8888);
