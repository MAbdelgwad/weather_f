...
public class WeatherPresentation {
    ...
    public static final String DEFAULT_WIND_DIRECTION_FORMAT = "abbr";
    ...
    public String toString() {
        return "WeatherPresentation{" + "roundedTemperature=" + roundedTemperature +
                ", temperatureUnits='" + temperatureUnits + '\'' + ", windSpeedUnits='"
                + windSpeedUnits + '\'' + ", windDirectionFormat='" + windDirectionFormat + '\'' +
                ", pressureUnits='" + pressureUnits + '\'' + ", shouldShowTemperatureInStatusBar=" +
                showTemperatureInStatusBar + ", weather=" + weather + ", type=" + type + '}';
    }
}