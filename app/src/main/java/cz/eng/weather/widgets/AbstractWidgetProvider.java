package cz.eng.weather.widgets;
...
import cz.eng.weather.BuildConfig;
...
public abstract class AbstractWidgetProvider extends AppWidgetProvider {
    ...
    protected static final String ACTION_UPDATE_TIME = "cz.eng.weather.UPDATE_TIME";
    ...
    protected String localize(SharedPreferences sp, Context context, String preferenceKey, String defaultValueKey) {
